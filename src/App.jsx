...
export default function App() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const to = 'team@clyptt.com'; // change if you want
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900">
            ...
            <section id="overview" className="relative overflow-hidden">
                ...
                <div
                    className="relative max-w-6xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-10 items-center text-white">
                    <div>
                        <p className="text-xs uppercase tracking-widest text-gray-400 mb-4">Perceptive Labs · Agentic
                            Suite for Retail</p>
                        <h1 className="text-4xl md:text-5xl font-semibold leading-tight mb-4">
                            Empowering retail with agents that <span
                            className="underline decoration-wavy decoration-gray-500">decide & deliver</span>
                        </h1>
                        <p className="text-gray-300 mb-6">
                            We turn fragmented sales, inventory and supplier data into **coordinated actions** —
                            **replenish, price, promote, renegotiate** — and deliver them to the channels you already
                            use.
                            No more dashboard staring. **Agents decide. You approve. Results move.**
                        </p>
                        ...
                        <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-gray-300">
                            ...
                            <div className="flex items-center gap-2"><Smartphone className="h-4 w-4"/>Phone & desktop
                            </div>
                        </div>
                    </div>
                    <div className="bg-white/5 rounded-3xl p-6 border border-white/10">
                        ...
                        <Button className="mt-4 w-full rounded-2xl bg-white text-gray-900 hover:bg-gray-100">Apply
                            all <ArrowRight className="h-4 w-4 ml-1"/></Button>
                    </div>
                </div>
            </section>
            ...
            <section id="suite" className="bg-white">
                <div className="max-w-6xl mx-auto px-4 py-16">
                    ...
                    <p className="text-gray-600 mb-8 max-w-2xl">A layered system that moves from data → decisions →
                        delivery, with governance built‑in. Modern, modular, and ready for real‑world retail.</p>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            },
                            {
                                ...
                                t: "Connector Hub",
                                d: "POS/Excel/CSV now; ERP and marketplace bridges next."
                            },
                            {
                            ...
                            },
                            {
                                ...
                                t: "ERP Bridges",
                                d: "Voucher‑safe exports and imports to your existing systems."
                            },
                            {
                                icon: <LineChart className="h-5 w-5"/>,
                                t: "Impact Feeds",
                                d: "Before/after metrics and weekly impact notes you can trust."
                            },
                        ].map((m, i) => (
                            <Card key={i} className="rounded-2xl">
                                <CardHeader className="flex items-center gap-3">
                        ...
                        {[
                            {
                                ...
                                pts: ["Smart replenishment", "Expiry risk watch", "Promo lift guidance"]
                            },
                            {
                                icon: <Store className="h-5 w-5"/>,
                                title: "Pharmacy",
                                pts: ["Batch/expiry controls", "Shortage radar", "Therapy substitutions"]
                            },
                            {
                                icon: <Store className="h-5 w-5"/>,
                                title: "Quick‑service F&B",
                                pts: ["Recipe costing", "Prep forecasts", "Vendor price checks"]
                            },
                            {
                                icon: <Store className="h-5 w-5"/>,
                                title: "Electronics",
                                pts: ["Assortment gaps", "Seasonal price nudges", "Warranty funnel nudges"]
                            },
                            {
                                icon: <Store className="h-5 w-5"/>,
                                title: "Fashion",
                                pts: ["Size‑color depth", "Markdown planning", "Repeat buyer activation"]
                            },
                            {
                                icon: <Store className="h-5 w-5"/>,
                                title: "Home & Lifestyle",
                                pts: ["Bundle suggestions", "Vendor SLAs", "Regional preferences"]
                            },
                        ].map((b, i) => (
                            <Card key={i} className="rounded-2xl">
                                <CardHeader className="flex items-center gap-3">
            ...
            <section id="usecases" className="bg-gray-50">
                <div className="max-w-6xl mx-auto px-4 py-16">
                    ...
                    <p className="text-gray-600 mb-8 max-w-2xl">A few ways teams use the suite to shift outcomes in
                        weeks, not quarters.</p>
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <Card key={i} className="rounded-2xl">
                                ...
                                <CardContent className="text-sm text-gray-600">
                                    <div className="flex items-center gap-2 mb-2"><Sparkles className="h-4 w-4"/>{c.a}
                                    </div>
                ...
                <div className="max-w-6xl mx-auto px-4 py-14">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 text-sm text-gray-700">
                        <div className="p-5 bg-gray-50 rounded-2xl border">
                            ...
                            <div>We don’t just flag issues — agents trace **why** (vendor lead time, price elasticity,
                                assortment depth) and propose the fix.
                            </div>
                        </div>
                        <div className="p-5 bg-gray-50 rounded-2xl border">
                            <div className="font-medium mb-1">Actions over dashboards</div>
                            <div>Every insight becomes an actionable list, message, or export. No “view only” charts.
                                **Move the business, not pixels.**
                            </div>
                        </div>
                        <div className="p-5 bg-gray-50 rounded-2xl border">
                            <div className="font-medium mb-1">Human‑in‑the‑loop control</div>
                            <div>Agents propose; you approve. Audit trail on every step. Private by design,
                                offline‑capable.
                            </div>
                        </div>
                    </div>
                        ...
                        {[
                            {
                                icon: <ShieldCheck className="h-5 w-5"/>,
                                t: "Privacy by design",
                                d: "Own your data. On‑prem options. No data brokers."
                            },
                            {
                                icon: <Workflow className="h-5 w-5"/>,
                                t: "Human in the loop",
                                d: "Agents propose. You approve. Audit trail everywhere."
                            },
                            {
                                icon: <Zap className="h-5 w-5"/>,
                                t: "Real‑world speed",
                                d: "Fast on modest hardware. Offline‑capable."
                            },
                            {
                                icon: <LineChart className="h-5 w-5"/>,
                                t: "Measured impact",
                                d: "Before/after metrics, not vanity charts."
                            },
                        ].map((p, i) => (
                            <Card key={i} className="rounded-2xl">
                                <CardHeader className="flex items-center gap-3">
                ...
                <div className="max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10">
                    ...
                    <div>
                        ...
                        <ul className="text-sm text-gray-700 space-y-3">
                            <li><span className="font-medium">Is this a dashboard?</span> No—agents produce actions you
                                can execute.
                            </li>
                            <li><span className="font-medium">Will it work with my POS?</span> Yes—via CSV/Excel now,
                                connectors next.
                            </li>
                            <li><span className="font-medium">How private is my data?</span> Local or on‑prem with audit
                                trails.
                            </li>
                        </ul>
                    </div>
                ...
                <div className="max-w-3xl mx-auto px-4 py-16">
                    ...
                    <form className="grid gap-4" onSubmit={handleSubmit}>
                        ...
                        <Input placeholder="Work email" value={email} onChange={e => setEmail(e.target.value)}
                               className="rounded-2xl"/>
                        <Textarea placeholder="Tell us about your retail footprint (stores, categories)" value={message}
                                  onChange={e => setMessage(e.target.value)} className="rounded-2xl"/>
                        <Button type="submit" className="rounded-2xl">Send</Button>
                    </form>
                    <p className="text-sm text-gray-500 mt-4">Prefer email? <a className="underline"
                                                                               href="mailto:team@clyptt.com">team@clyptt.com</a>
                    </p>
                </div>
            </section>
